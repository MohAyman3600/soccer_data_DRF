...
class BaseScraper(object):
    ...
    # def get_player_stats(self, querystring):
    #     """
    ...
    #     response = self.send_request('players', querystring)
    ...
    #                 print('exception')
    #                 season_year = str(
    #                     player_data['statistics'][0]['league']['season'])
    #                 self.get_players(
    #                     querystring={
    #                         "id": str(player_data['player']['id']),
    #                         'season': season_year
    #                     })
    #                 player = Player.objects.get(id=player_data['player']['id'])
    ...
    #                     league = League.objects.get(id=stats['league']['id'])
    #                     season = league.seasons.get(
    #                         year=stats['league']['season'])

    #                 except League.DoesNotExist or Season.DoesNotExist:

    #                     self.get_leagues(
    #                         querystring={"id": str(stats['league']['id'])})
    #                     league = League.objects.get(id=stats['league']['id'])
    #                     season = league.seasons.get(
    #                         year=stats['league']['season'])
    ...
    #                     'games_rating': stats['games']['rating'],
    #                     'goals_assisted': stats['games']['assisted'],
    #                     'goals_scored': stats['goals']['scored'],
    #                     'goals_conceded': stats['goals']['conceded'],
    #                     'player': model_to_dict(player),
    #                     'season': model_to_dict(season),
    #                 }
    #                 if PlayerStats.objects.filter(
    #                     player=data['player']['id'],
    #                     season=data['season']['id']
    #                 ).exists():
    #                     logger.info(
    #                         f"Player with id:{player_data['player']['id']} statistics already exists")
    #                     logger.info("Updataing Object")
    #                     print(self.create_or_update(
    #                         data,
    #                         PlayerStatsSerializer,
    #                         instance=PlayerStats.objects.filter(
    #                             player=data['player']['id'],
    #                             season=data['season']['id'],
    #                         ).first()
    #                     ))
